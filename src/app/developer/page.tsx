...
import { Code2, ShieldCheck, ChevronRight } from "lucide-react";
import { getToolsByCategory } from "@/config/tools";
import { ToolCard } from "@/components/tools/tool-card";
import { constructMetadata, generateCategoryJsonLd } from "@/lib/seo";

export const metadata: Metadata = constructMetadata({
  title: "Free Developer Tools — JSON, JWT, RegEx, Base64 & Hashes",
  description:
    "A free suite of 10 client-side developer utilities. Inspect JWTs, format JSON, test RegEx, generate UUIDs, encode Base64, and calculate hashes with complete security.",
...
export default function DeveloperHubPage() {
  ...
  const jsonLd = generateCategoryJsonLd({
    ...
    description:
      "Inspect JWTs, format JSON, test RegEx, generate UUIDs, and calculate cryptographic hashes safely in-browser.",
    tools,
  });
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-50 text-blue-600 border border-blue-200/60 shadow-xs">
